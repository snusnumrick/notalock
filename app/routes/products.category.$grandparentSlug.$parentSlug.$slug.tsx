...
export async function loader({ params, request }: LoaderFunctionArgs) {
  ...
  if (!grandparentSlug || !parentSlug || !slug) {
    throw new Response('Category not found', { status: 404 });
  }

  // Find grandparent and parent categories for validation
  const grandparentCategory = findCategoryBySlug(grandparentSlug);
  ...
  // Find the actual category we want to display
...
// Export component to render products for this sub-subcategory
export default function SubSubCategoryProducts() {
  ...
  console.log('SubSubCategoryProducts - loaderData:', {
